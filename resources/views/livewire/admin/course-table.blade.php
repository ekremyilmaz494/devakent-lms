<div>
    ...
    <div class="flex items-center gap-1 mb-4 bg-gray-100 dark:bg-gray-800 rounded-lg p-1 w-fit">
        ...
        <button wire:click="filterByStatus('published')" wire:loading.attr="disabled" wire:target="filterByStatus"
            class="px-3 py-1.5 text-xs font-medium rounded-md transition-colors {{ $filterStatus === 'published' ? 'bg-white dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white' }}">
        ...
        <button wire:click="filterByStatus('draft')" wire:loading.attr="disabled" wire:target="filterByStatus"
            class="px-3 py-1.5 text-xs font-medium rounded-md transition-colors {{ $filterStatus === 'draft' ? 'bg-white dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white' }}">
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    @forelse($courses as $course)
                        <tr wire:key="course-{{ $course->id }}" class="hover:bg-gray-50/50 dark:hover:bg-gray-700/20 transition-colors {{ in_array($course->id, $selectedCourses) ? 'bg-primary-50/50 dark:bg-primary-900/10' : '' }}">
                            <td class="px-4 py-3">
