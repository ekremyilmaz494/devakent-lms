<nav class="flex items-center gap-1.5 text-sm" aria-label="Breadcrumb">
    <a href="{{ route('admin.dashboard') }}" class="flex items-center text-gray-400 dark:text-gray-500 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
