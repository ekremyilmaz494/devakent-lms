...
<div class="space-y-6">
    {{-- Welcome Banner --}}
    <div class="bg-gradient-to-r from-primary-500 via-primary-600 to-primary-700 rounded-2xl p-6 text-white relative overflow-hidden">
        ...
        <div class="relative">
            ...
            <p class="mt-1 text-primary-100">{{ $user->title ?? 'Personel' }} &middot; {{ $user->department?->name ?? 'Departman atanmamış' }}</p>
        </div>
        @if($stats['total'] > 0)
        ...
        <p class="relative text-xs text-primary-100 mt-1">Genel ilerleme: {{ $stats['completed'] }}/{{ $stats['total'] }} eğitim tamamlandı</p>
        @endif
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <div class="p-5">
                ...
                <p class="text-xs text-gray-600 dark:text-gray-400 mt-0.5">Tamamlanan</p>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <div class="p-5">
                ...
                <p class="text-xs text-gray-600 dark:text-gray-400 mt-0.5">Devam Eden</p>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <div class="p-5">
                ...
                <p class="text-xs text-gray-600 dark:text-gray-400 mt-0.5">Başlanmamış</p>
            </div>
        </div>
    ...
    <div>
        <div class="flex items-center justify-between mb-4">
            ...
            @if($enrollments->count() > 6)
                <a href="{{ route('staff.courses.index') }}" class="text-sm text-primary-600 dark:text-primary-400 hover:underline font-medium">Tümünü Gör</a>
            @endif
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <a href="{{ route('staff.courses.show', $enrollment->course_id) }}"
               class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-md hover:border-primary-200 dark:hover:border-primary-800 transition-all group">
                {{-- Color Bar --}}
                ...
                <div class="p-5">
                    ...
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <span class="text-xs font-medium px-2 py-0.5 rounded-full
                            ...
                            @elseif($enrollment->status === 'in_progress') bg-primary-100 dark:bg-primary-900/30 text-primary-700 dark:text-primary-300
                    ...
                    {{-- Title --}}
                    <h4 class="font-semibold text-gray-800 dark:text-white group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors line-clamp-2">{{ $enrollment->course->title }}</h4>

                    {{-- Info --}}
                    <div class="flex items-center gap-3 mt-3 text-xs text-gray-600 dark:text-gray-400">
