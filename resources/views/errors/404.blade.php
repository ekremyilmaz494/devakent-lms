...
<head>
    ...
    <title>404 - Sayfa Bulunamadi | Devakent LMS</title>
...
<body class="font-sans antialiased bg-[var(--color-background)] min-h-screen flex items-center justify-center p-6">
    <div class="text-center max-w-lg">
        ...
        <h1 class="text-2xl font-bold text-gray-800 mb-3">Sayfa Bulunamadi</h1>
        <p class="text-gray-500 mb-8">Aradiginiz sayfa mevcut degil veya tasindi. Lutfen adresi kontrol edin.</p>
