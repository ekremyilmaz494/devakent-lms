    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div class="lg:col-span-3">
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
                ...
                @if($activeTab === 'general')
                    ...
                    <form wire:submit="saveGeneral" class="p-6 space-y-5">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                                <label class="text-xs font-medium text-gray-700 dark:text-gray-400 mb-1.5 block">Kurum Adı</label>
                            ...
                            <div>
                                <label class="text-xs font-medium text-gray-700 dark:text-gray-400 mb-1.5 block">Kurum Alt Başlığı</label>
                        ...
                        <div>
                            <label class="text-xs font-medium text-gray-700 dark:text-gray-400 mb-1.5 block">Logo URL</label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                                <label class="text-xs font-medium text-gray-700 dark:text-gray-400 mb-1.5 block">Zaman Dilimi</label>
                            ...
                            <div>
                                <label class="text-xs font-medium text-gray-700 dark:text-gray-400 mb-1.5 block">Varsayılan Dil</label>
                ...
                @if($activeTab === 'exam')
                    ...
                    <form wire:submit="saveExam" class="p-6 space-y-5">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                            <div>
                                <label class="text-xs font-medium text-gray-700 dark:text-gray-400 mb-1.5 block">Sınav Süresi (dk)</label>
                            ...
                            <div>
                                <label class="text-xs font-medium text-gray-700 dark:text-gray-400 mb-1.5 block">Geçme Puanı</label>
                            ...
                            <div>
                                <label class="text-xs font-medium text-gray-700 dark:text-gray-400 mb-1.5 block">Maks. Deneme</label>
                ...
                @if($activeTab === 'backup')
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <h3 class="text-sm font-semibold text-gray-900 dark:text-white">Veri Yedekleme</h3>
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button wire:click="createBackup" wire:loading.attr="disabled"
                                ...
                                <span wire:loading.remove wire:target="createBackup">Yeni Yedek Oluştur</span>
                                ...
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    <thead class="bg-gray-50 dark:bg-gray-800/50">
                                        <tr>
                                            ...
                                            <th class="px-4 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Boyut</th>
                        ...
                        @else
                            <div class="text-center py-10 border border-dashed border-gray-300 dark:border-gray-600 rounded-lg">
                                ...
                                <p class="mt-3 text-sm text-gray-500 dark:text-gray-400">Henüz yedek dosyası oluşturulmamış</p>
                            ...
                            <div class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50" wire:click.self="$set('showDeleteBackupModal', false)">
                                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-sm w-full p-6">
                                    <div class="flex items-center gap-3 mb-4">
                                        ...
                                        <div>
                                            <h3 class="text-sm font-semibold text-gray-900 dark:text-white">Yedeği Sil</h3>
